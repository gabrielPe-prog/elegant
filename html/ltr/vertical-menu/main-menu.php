<div class="main-menu menu-fixed menu-dark menu-bg-default rounded menu-accordion menu-shadow">
      <div class="main-menu-content"><a class="navigation-brand d-none d-md-block d-lg-block d-xl-block" href="index.php"><img class="brand-logo" alt="logomarca da Prefeitura" src="../../../app-assets/images/logo/logo.png"/></a>
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class="active"><a href="../../../html/ltr/vertical-menu/index.php"><i class="icon-grid"></i><span class="menu-title" data-i18n="">Painel</span></a>
          </li>
          <li class=" nav-item"><a href="sorteio.php"><i class="icon-layers"></i><span class="menu-title" data-i18n="">Sorteio</span></a>
          </li>
          <li class=" nav-item"><a href="sorteados.php"><i class="icon-present"></i><span class="menu-title" data-i18n="">Sorteados</span></a>
          </li>
